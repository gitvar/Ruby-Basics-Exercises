...
def find_dup(array)
  ...
  dup = search_array.each_with_index do |element, index|
    break element if element == search_array[index+1]
  end
  dup == array.sort ? nil : dup
end
...
p find_dup([18,  9, 36, 96, 31, 19, 54, 75, 42, 15,
          ...
          78, 76, 48, 16, 93, 77, 52, 49, 37, 29,
          89, 10, 84,  1, 47, 68, 12, 33, 86, 60,
          41, 44, 83, 35, 94, 98,  3, 64, 82, 73,
          55, 79, 80, 21, 39, 72, 13, 50,  6, 70,
          85, 87, 51, 17, 66, 20, 28, 26,  2, 22,
          40, 23, 71, 62, 73, 32, 43, 24, 4, 56, 97,
          7,  34, 57, 74, 45, 11, 88, 67,  5, 58]) #== nil
